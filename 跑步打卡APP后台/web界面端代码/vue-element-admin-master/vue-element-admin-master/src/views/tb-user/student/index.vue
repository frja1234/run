    ...
    <div class="filter-container">
      ...
      <el-dialog :title="InsertDiagInfo.title"
        ...
        <InsertDiagUser :visible.sync="InsertDiagInfo.visible"
                        @getTableData="getTableData('student')">
          <!-- :visible.sync双向绑定数据
      ...
      <el-table-column label="教师"
        ...
        <template slot-scope="scope">
          <div slot="reference"
            ...
            <el-tag size="medium"
                    type="info"
                    v-if="typeof (scope.row.teacher.userRealName) === 'undefined'">未选定教师</el-tag>
            <el-tag size="medium"
                    type="success"
                    v-else>{{ scope.row.teacher.userRealName }}</el-tag>
        ...
        <template slot-scope="scope">
          <div slot="reference"
            ...
            <el-tag size="medium"
                    type="info"
                    effect="dark"
                    v-if="typeof (scope.row.className) === 'undefined'">未分配班级</el-tag>
            <el-tag size="medium"
                    type="primary"
                    effect="dark"
                    v-else>{{ scope.row.className }}</el-tag>
...
export default {
  ...
  mounted: function () {
    this.getClasses() // 查询所有的班级
    this.getTableData('student') //需要触发的函数
  },
  methods: {
    // 获取所有的班级
    getClasses () {
    ...
    // 处理插入操作
    handleCreate () {
      this.InsertDiagInfo.title = '新增学生' // 设置题目
    ...
    handleUpdate (userId) {
      ...
      this.UpdateDiagInfo.title = '编辑学生' // 设置题目
